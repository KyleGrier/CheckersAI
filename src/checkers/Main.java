...
public class Main {
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (init) {
      ...
      ByteArrayInputStream mess = new ByteArrayInputStream(message.getBytes()); // Remove later
      System.setIn(mess); //Remove later
    ...
    while ((input_message = br.readLine()) != null) {
      ...
      ByteArrayInputStream outtie = new ByteArrayInputStream(output_message.getBytes()); // Remove later
      System.setIn(outtie);
